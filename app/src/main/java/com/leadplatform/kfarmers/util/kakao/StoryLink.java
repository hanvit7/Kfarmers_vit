...
public class StoryLink {
	 ...
	 * @param params
	 */
	private void openStoryLink(Fragment activity, String params) {
		Intent intent = new Intent(Intent.ACTION_SEND, Uri.parse(params));
		activity.startActivity(intent);
	}
	
	private void openStoryLink(Context activity, String params) {
	    Intent intent = new Intent(Intent.ACTION_SEND, Uri.parse(params));
	    activity.startActivity(intent);
	}
	 ...
	 * @param urlInfoArray
	 */
	public void openKakaoLink(Fragment activity, String post, String appId, String appVer, String appName, String encoding,
	...
	public void openKakaoLink(Context activity, String post, String appId, String appVer, String appName, String encoding,
	        Map<String, Object> urlInfoAndroid) {
	...
	public void openStoryLinkImageApp(Context activity, String path) {
	    Intent intent = new Intent(Intent.ACTION_SEND);
	    intent.setType("image/png");
	    intent.putExtra(Intent.EXTRA_STREAM, Uri.parse(path));
	    intent.setPackage("com.kakao.story");
