...
public class CenterController {
	...
	public static void getListDiary(final DiaryListData data, CenterResponseListener responseHandler) {
		RequestParams params = new RequestParams();
	...
	public static void getListDiary(Context context, final DiaryListData data, CenterResponseListener responseHandler) {
		RequestParams params = new RequestParams();
	...
	public static void getDailyList(String oldDate, CenterResponseListener responseHandler) {
		RequestParams params = new RequestParams();
