...
public class VillageReleaseListFragment extends BaseListFragment
{
    public static final String TAG = "VillageReleaseListFragment";

    private final String villagePrimaryIndexTable[] = { "7", "9" };
    private ArrayList<CategoryJson> releaseItemList;
    private ReleaseListAdapter releaseListAdapter;

    public static VillageReleaseListFragment newInstance()
    {
        final VillageReleaseListFragment f = new VillageReleaseListFragment();
        return f;
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        KfarmersAnalytics.onScreen(KfarmersAnalytics.S_EXPERIENCE_MANAGE_LIST, null);
    }
        ...
        if (releaseListAdapter == null)
        {
            ...
            releaseListAdapter = new ReleaseListAdapter(getSherlockActivity(), R.layout.item_release, releaseItemList, new ViewOnClickListener()
            {
                ...
                public void viewOnClick(View v)
                {
                    ...
                    ((VillageReleaseActivity) getSherlockActivity()).runReleaseEditFragment(listData);
                    KfarmersAnalytics.onClick(KfarmersAnalytics.S_EXPERIENCE_MANAGE_LIST, "Click_Item", item.SubName);
                }
            });
                        ...
                        case 0000:
                            ...
                            if (root.findPath("List").isArray())
                            {
                                ...
                                while (it.hasNext())
                                {
                                    ...
                                    for (int index = 0; index < villagePrimaryIndexTable.length; index++)
                                    {
                                        if (category.PrimaryIndex.equals(villagePrimaryIndexTable[index]))
                                        {
