...
public class JoinFarmerNextFragment extends BaseFragment {
	public static final String TAG = "JoinFarmerNextFragment";
	...
	private JoinFarmerData joinData;
	...
	public static JoinFarmerNextFragment newInstance(JoinFarmerData data) {
		final JoinFarmerNextFragment f = new JoinFarmerNextFragment();

		final Bundle args = new Bundle();
		args.putParcelable(JoinFarmerData.KEY, data);
		f.setArguments(args);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			joinData = getArguments().getParcelable(JoinFarmerData.KEY);
		}
	}

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View v = inflater.inflate(R.layout.fragment_join_farmer_next, container, false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		completBtn.setOnClickListener(new ViewOnClickListener() {
			...
			public void viewOnClick(View v) {
				if (getSherlockActivity() instanceof JoinFarmerActivity) {
					((JoinFarmerActivity) getSherlockActivity()).onCompletBtnClicked(makeCompleteBtnData());
				}
			}
		});
		...
		((JoinFarmerActivity) getSherlockActivity()).initActionBarRightBtnComplete();
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getGroupId() == CONTEXT_MENU_GROUP_ID) {
			...
			case R.id.btn_camera_capture:
				if (getSherlockActivity() instanceof JoinFarmerActivity) {
					imagePath[imageIndex] = ImageUtil.takePictureFromCameraFragment(getSherlockActivity(), JoinFarmerNextFragment.this, Constants.REQUEST_TAKE_CAPTURE);
				}
				return true;
			case R.id.btn_camera_gallery:
				if (getSherlockActivity() instanceof JoinFarmerActivity) {
					ImageUtil.takePictureFromGalleryFragment(getSherlockActivity(), JoinFarmerNextFragment.this, Constants.REQUEST_TAKE_PICTURE);
				}
				return true;
			}
		}
	...
	public JoinFarmerData makeCompleteBtnData() {
