 ...
 * @author MJ
 */
public class KakaoLoginActivity extends BaseFragmentActivity
{
	...
	public void onCreateView(Bundle savedInstanceState) {
		setContentView(R.layout.fragment_sns_kakao);
    ...
    public void onResume()
    {
        super.onResume();
        // 세션을 초기화 한다
        if (Session.initializeSession(mContext, mySessionCallback))
        {
    ...
    private class MySessionStatusCallback implements SessionCallback
    {
        ...
        public void onSessionClosed(final KakaoException exception)
        {
            ...
            DbController.updateKakaoFlag(KakaoLoginActivity.this, false);
        }
