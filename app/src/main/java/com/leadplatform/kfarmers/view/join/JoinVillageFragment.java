...
public class JoinVillageFragment extends BaseFragment {
	public static final String TAG = "JoinVillageFragment";
	...
	public static JoinVillageFragment newInstance() {
		final JoinVillageFragment f = new JoinVillageFragment();
		return f;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View v = inflater.inflate(R.layout.fragment_join_village, container, false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		duplicateBtn.setOnClickListener(new ViewOnClickListener() {
			...
			public void viewOnClick(View v) {
				if (getSherlockActivity() instanceof JoinVillageActivity) {
					((JoinVillageActivity) getSherlockActivity()).onDuplicateBtnClicked(idEdit.getText().toString());
				}
			}
		});
		...
		nextBtn.setOnClickListener(new ViewOnClickListener() {
			...
			public void viewOnClick(View v) {
				if (getSherlockActivity() instanceof JoinVillageActivity) {
					((JoinVillageActivity) getSherlockActivity()).onNextBtnClicked(makeNextBtnData());
				}
			}
		});
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getGroupId() == CONTEXT_MENU_GROUP_ID) {
			...
			case R.id.btn_camera_capture:
				if (getSherlockActivity() instanceof JoinVillageActivity) {
					profilePath = ImageUtil.takePictureFromCameraFragment(getSherlockActivity(), JoinVillageFragment.this, Constants.REQUEST_TAKE_CAPTURE);
				}
				return true;
			case R.id.btn_camera_gallery:
				if (getSherlockActivity() instanceof JoinVillageActivity) {
					ImageUtil.takePictureFromGalleryFragment(getSherlockActivity(), JoinVillageFragment.this, Constants.REQUEST_TAKE_PICTURE);
				}
				return true;
			}
		}
	...
	public JoinVillageData makeNextBtnData() {
		JoinVillageData data = new JoinVillageData();
