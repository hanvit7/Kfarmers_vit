...
//빌리지 메뉴
public class MenuVillageFragment extends BaseFragment {
	public static final String TAG = "MenuVillageFragment";

    private final int menuBtnResourceId[] = {R.id.ItemStatus, R.id.userLayout, R.id.homeText,R.id.editText, R.id.buyText, R.id.cartText, R.id.favoriteText, R.id.expInfoText, R.id.replyText,R.id.Setting,R.id.ProductText,R.id.InquiryText,R.id.PointText, R.id.reviewText};
	...
	public static MenuVillageFragment newInstance(String profile) {
		final MenuVillageFragment f = new MenuVillageFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View v = inflater.inflate(R.layout.fragment_menu_right_village, container, false);
	...
	private void runMenuActivity(int resourceId) {
		...
		switch (resourceId) {
            case R.id.ItemStatus:
				...
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Communication", null);
                break;
            case R.id.userLayout:
                intent = new Intent(getActivity(), EditVillageActivity.class);
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Edit", null);
                break;
            case R.id.homeText:
				if (profileJson.PermissionFlag.equals("N")) {
					...
					((BaseMenuFragmentActivity) getActivity()).toggle();
					KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Farm", profileJson.Farm);
				}
                break;
            case R.id.favoriteText:
				...
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Favorite", null);
                break;
            case R.id.expInfoText:
                intent = new Intent(getActivity(), VillageReleaseActivity.class);
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Experience", null);
                break;
            case R.id.replyText:
				...
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Reply", null);
                break;
            case R.id.editText:
                intent = new Intent(getActivity(), EditVillageActivity.class);
				((BaseMenuFragmentActivity) getActivity()).toggle();
            ...
            case R.id.buyText:
				...
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Order", null);
                break;
            case R.id.cartText:
                intent = new Intent(getActivity(), CartActivity.class);
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Cart", null);
                break;
            case R.id.Setting:
                intent = new Intent(getActivity(), SettingActivity.class);
				((BaseMenuFragmentActivity) getActivity()).toggle();
				KfarmersAnalytics.onClick(KfarmersAnalytics.S_MYPAGE_VILLAGE, "Click_Setting", null);
                break;
            case R.id.Terms:
			...
			case R.id.ProductText:
				//UiDialog.showDialog(getActivity(),R.string.dialog_ready_product);
