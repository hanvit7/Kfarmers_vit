...
public class JoinVillageActivity extends BaseFragmentActivity
{
    public static final String TAG = "JoinVillageActivity";
    ...
    private void initContentView(Bundle savedInstanceState)
    {
        ...
        {
            JoinVillageFragment fragment = JoinVillageFragment.newInstance();
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.add(R.id.fragment_container, fragment, JoinVillageFragment.TAG);
            ft.commit();
        }
    }
    ...
    public void initActionBar()
    {
        ...
        title.setText(R.string.JoinTitleVillage);
    }
    ...
    public void initActionBarRightBtnNext()
    {
        ...
        rightBtn.setOnClickListener(new ViewOnClickListener()
        {
            ...
            {
                JoinVillageFragment fragment = (JoinVillageFragment) getSupportFragmentManager().findFragmentByTag(JoinVillageFragment.TAG);
                if (fragment != null)
    ...
    public void initActionBarRightBtnComplete()
    {
        ...
        rightBtn.setOnClickListener(new ViewOnClickListener()
        {
            ...
            public void viewOnClick(View v)
            {
                JoinVillageNextFragment fragment = (JoinVillageNextFragment) getSupportFragmentManager().findFragmentByTag(
                        JoinVillageNextFragment.TAG);
                if (fragment != null)
        ...
        CenterController.checkID(id, new CenterResponseListener(this)
        {
            ...
            public void onSuccess(int Code, String content)
            {
                try
                {
                    ...
                    {
                        case 0000:
                            JoinVillageFragment fragment = (JoinVillageFragment) getSupportFragmentManager().findFragmentByTag(
                                    JoinVillageFragment.TAG);
                            if (fragment != null)
                            {
    ...
    public void onNextBtnClicked(JoinVillageData data)
    {
        ...
        JoinVillageNextFragment fragment = JoinVillageNextFragment.newInstance(data);
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.add(R.id.fragment_container, fragment, JoinVillageNextFragment.TAG);
        ft.addToBackStack(null);
        ft.commit();
    }

    public void onCompletBtnClicked(JoinVillageData data)
    {
        if (!data.isAgreeFlag())
        {
        ...
        {
            UiController.showDialog(mContext, R.string.dialog_invalid_village);
            return;
        }
        ...
        CenterController.joinVillage(data, new CenterResponseListener(this)
        {
            @Override
            public void onSuccess(int Code, String content)
            {
                    ...
                    switch (Code)
                    {
                        case 0000:
                            UiController.showDialog(mContext, R.string.dialog_success_join, new CustomDialogListener()
                            {
                                ...
                                {
                                    Intent intent = new Intent(JoinVillageActivity.this, LoginActivity.class);
