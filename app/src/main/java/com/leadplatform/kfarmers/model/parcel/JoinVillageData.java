...
public class JoinVillageData implements Parcelable {
	public static final String KEY = "JoinVillageData";
	...
	// Parcelable
	/***************************************************************/
	public JoinVillageData(Parcel in) {
		readFromParcel(in);
	}
	...
	public static final Parcelable.Creator<JoinVillageData> CREATOR = new Parcelable.Creator<JoinVillageData>() {

		@Override
		public JoinVillageData createFromParcel(Parcel source) {

			return new JoinVillageData(source);

		}

		@Override
		public JoinVillageData[] newArray(int size) {

			return new JoinVillageData[size];
