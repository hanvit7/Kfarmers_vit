...
public class QuickReturnScrollViewOnScrollChangedListener implements NotifyingScrollView.OnScrollChangedListener {
    ...
    private boolean isAnimUp = false , isAnimDown = false;
            ...
            case FOOTER:
                if(diff <=0){ // scrolling down
                    if(!isAnimDown) {
                        ...
                        downAnim = ObjectAnimator.ofFloat(mFooter, "translationY", mFooter.getTranslationY(), mMinFooterTranslation);
                    ...
                    if(!isAnimUp) {
                        ...
                        upAnim = ObjectAnimator.ofFloat(mFooter, "translationY", mFooter.getTranslationY(), 0);
