...
public class RequestParams implements Serializable {
    ...
    protected List<FileWrapper> fileParamsNaver = new ArrayList<FileWrapper>();
    ...
    public void addAll(List<File> files) {
        if (files != null) {
            fileParamsNaver = new ArrayList<RequestParams.FileWrapper>();
        	for(File file : files)
        	{
        		fileParamsNaver.add(new FileWrapper(file, null, null));
        	}
        }
    }
    ...
    public HttpEntity getEntity(ResponseHandlerInterface progressHandler) throws IOException {
        ...
        } else if (streamParams.isEmpty() && fileParams.isEmpty() && fileParamsNaver.isEmpty()) {
    ...
    private HttpEntity createJsonStreamerEntity(ResponseHandlerInterface progressHandler) throws IOException {
        ...
        // Add file params
        for (FileWrapper entry : fileParamsNaver) {
            entity.addPart("image", entry);
        }
    ...
    private HttpEntity createMultipartEntity(ResponseHandlerInterface progressHandler) throws IOException {
        ...
        // Add file params
        for (FileWrapper fileWrapper : fileParamsNaver) {
            entity.addPart("image", fileWrapper.file, fileWrapper.contentType, fileWrapper.customFileName);
        }
